...
namespace Vulkan
{
    ...
    public partial class Device : IMarshalling
    {
        ...
        public IntPtr MapMemory(DeviceMemory memory, DeviceSize offset, DeviceSize size, MemoryMapFlags flags = (MemoryMapFlags)0)
        {
            Result result;
            IntPtr ppData;
            unsafe
        ...
        public void ResetDescriptorPool(DescriptorPool descriptorPool, DescriptorPoolResetFlags flags = (DescriptorPoolResetFlags)0)
        {
            Result result;
            unsafe
            {
        ...
        public void TrimCommandPool(CommandPool commandPool, CommandPoolTrimFlags flags = (CommandPoolTrimFlags)0)
        {
            unsafe
            {
