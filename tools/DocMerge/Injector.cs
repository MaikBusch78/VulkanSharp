...
namespace VulkanSharp.DocMerge
{
    ...
    {
        string vulkanDocsPath = "Vulkan-Docs";
        string vulkanSharpDocsPath = "docs/en/Vulkan";

        public Injector()
        {
            ReadTypesInfo();
            ReadTxtDocInDirectory(Path.Combine(vulkanDocsPath, "chapters"));
        }

        #region ReadTypesInfo
        ...
        {
            var path = Path.Combine(vulkanSharpDocsPath, csName + ".xml");
